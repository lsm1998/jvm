...
public class ClassRead
{
    ...
    static
    {
        ...
        versionMap.put(57, "jdk13");
        versionMap.put(56, "jdk12");
    ...
    private void handler()
    {
        ...
        {
            throw new RuntimeException("class file struct error!");
        }
        if (!validateCompiledVersion())
        {
            throw new RuntimeException("validateMagicNumber error!");
        }
    ...
    private boolean validateMagicNumber()
    {
        ...
        for (int i = 0; i < temp.length; i++, currentIndex++)
        {
            ...
            {
                log.error("魔数格式错误,MagicNumber={}",temp);
                return false;
            }
        }
        return true;
    ...
    private boolean validateCompiledVersion()
    {
        ...
        {
            log.error("不支持的编译版本,version={}",version);
            return false;
        }
    }
